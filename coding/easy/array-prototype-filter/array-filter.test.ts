...
const isSquareEven = (_: any, index: number, array: Array<any>) => (array[index] * array[index]) % 2 === 0;
const isSquareOdd = (_: any, index: number, array: Array<any>) => (array[index] * array[index]) % 2 === 1;
