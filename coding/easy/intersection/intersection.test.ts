...
describe('intersection', () => {
  ...
  test('multiple arrays', () => {
    ...
    expect(intersection(['a', 'b', 'c'], ['b', 'c', 'd'], ['c', 'e', 'f'])).toEqual(['c']);
  });
  ...
  test('different types of elements', () => {
    ...
    expect(intersection(['a', 'b', 'c'], [1, 'b', true], [false, 'b', 'c'])).toEqual(['b']);
    expect(intersection([null, undefined], [undefined, NaN], [NaN, null])).toEqual([]);
  });
});
